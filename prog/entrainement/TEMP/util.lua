...
function Util.Rect(r, g, b, pType, x1, y1, x2, y2)
  love.graphics.setColor(r, g, b)
  love.graphics.line(pType, x1, y1, x2, y2)
  love.graphics.setColor(1, 1, 1)
end

function Util.Polygon(r, g, b, pType, x1, y1, x2, y2, x3, y3, ...)
  love.graphics.setColor(r, g, b)
  love.graphics.line(pType, r, g, b, pType, x1, y1, x2, y2, x3, y3, ...)
  love.graphics.setColor(1, 1, 1)
end

function Util.Circle(r, g, b, origine_x, origine_y, rayon)
  love.graphics.setColor(r, g, b)
  love.graphics.line(pType, r, g, b, origine_x, origine_y, rayon)
  love.graphics.setColor(1, 1, 1)
end
